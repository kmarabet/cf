						...
						<div class="col-xs-12">
							...
							<div class="error-container">
								<div class="well">
									...
									<hr />
									<h3 class="lighter smaller"><spring:message code="error.404.could_not_find"/></h3>

									<div>
										<h4 class="smaller"><spring:message code="error.404.try.header"/>:</h4>

										<ul class="list-unstyled spaced inline bigger-110 margin-15">
											<li>
												<i class="ace-icon fa fa-hand-o-right blue"></i>
												<spring:message code="error.404.try.solution.1"/>
											</li>

											<li>
												<i class="ace-icon fa fa-hand-o-right blue"></i>
												<spring:message code="error.404.try.solution.2"/>
											</li>
										</ul>
									</div>
									...
									<div class="center">
										<a href="javascript:history.back()" class="btn btn-grey">
											...
											<spring:message code="error.404.button.back"/>
										</a>
									</div>
								</div>
							</div>
